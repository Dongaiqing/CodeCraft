class Queries():
    ...
    @staticmethod
    def getAllOtherUserName():
        return 'SELECT username FROM UserProfile WHERE username <> %s'
    ...
    @staticmethod
    def getRoadMapForUser():
        return 'SELECT roadmapID FROM UserProfile_RoadMap WHERE userID=(SELECT id FROM UserProfile WHERE username=%s)'
    ...
    @staticmethod
    def getFriends():
        return 'SELECT friendName FROM UserProfile_Friends WHERE userID = (SELECT id FROM UserProfile WHERE username=%s)'

    @staticmethod
    def getUserWithSameLevel():
        return 'SELECT id FROM UserProfile WHERE userLevel = (SELECT userLevel FROM UserProfile WHERE id =(SELECT id FROM UserProfile WHERE username=%s))'